        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <a
              ...
              className="text-xs font-bold text-slate-700 hover:text-teal-700 flex items-center space-x-1.5"
            >
            ...
            <Link
              to="/appointment"
              className="inline-flex items-center space-x-2 bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm px-5 py-2.5 rounded-xl shadow-sm hover:shadow transition-all"
            >
        ...
        <div className="md:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-3 animate-fadeIn">
          ...
          <div className="pt-2 border-t border-slate-100 flex flex-col space-y-2">
            <Link
              to="/appointment"
              onClick={() => setMobileMenuOpen(false)}
              className="w-full inline-flex items-center justify-center space-x-2 bg-teal-600 text-white font-bold text-sm py-3 rounded-xl shadow"
            >
              <Calendar className="w-4 h-4" />
