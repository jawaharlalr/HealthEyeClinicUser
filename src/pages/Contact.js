    ...
    <div className="py-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12 bg-slate-50 text-slate-900">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 border border-slate-200/90 shadow-card space-y-4">
            ...
            <div className="pt-2 flex flex-wrap gap-2">
              <a
                ...
                className="inline-flex items-center space-x-2 text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 border border-slate-300 px-4 py-2.5 rounded-xl transition shadow-sm"
              >
          ...
          {/* Working Hours (Light Theme Card) */}
          <div className="bg-slate-50 text-slate-900 rounded-3xl p-6 border border-slate-200 shadow-card space-y-4">
            <div className="flex items-center space-x-2 text-teal-700">
              <Clock className="w-5 h-5" />
              <h3 className="text-base font-extrabold text-slate-900">Clinic Working Schedule</h3>
            </div>

            <div className="space-y-2 text-xs sm:text-sm">
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                <span className="text-slate-600 font-medium">Tuesday – Sunday</span>
                <span className="text-teal-800 font-bold">11:00 AM – 4:00 PM</span>
              </div>
              <div className="flex justify-between py-1.5">
                <span className="text-slate-600 font-medium">Monday</span>
                <span className="text-pink-600 font-bold uppercase">CLOSED</span>
              </div>
            </div>

            <Link
              to="/appointment"
              className="w-full inline-flex items-center justify-center space-x-2 bg-teal-600 hover:bg-teal-700 text-white font-extrabold py-3 rounded-xl transition text-xs shadow-md"
            >
